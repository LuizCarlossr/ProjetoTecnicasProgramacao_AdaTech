...
public class CreateTaskCommand implements Command {
    ...
    public void execute() {
        ...
        String statusStr = view.getInput("🔄 Informe o status (Pendente, " +
                "Em andamento, Bloqueado, Concluído) (ou deixe em branco para 'Pendente')");

        try { Task.Status status = Optional.ofNullable(statusStr)
                    .filter(s -> !s.isBlank())
        ...
        } catch (IllegalArgumentException e) { view.showMessage("❌ Erro: " + e.getMessage()); }
    }
}
